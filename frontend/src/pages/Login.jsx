    ...
    return (
        <div className="flex items-start justify-center py-4 sm:py-6 md:py-8 px-4">
            <div className="bg-cyan-800 backdrop-blur-sm rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 w-full max-w-md">
                {/* Titre */}
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white text-center mb-4 sm:mb-6">Connexion</h1>
                ...
                {successMessage && <p className="text-green-700 bg-green-100 p-2 rounded mb-4 text-xs sm:text-sm">{successMessage}</p>}
                ...
                <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                    ...
                    {/* Mot de passe */}
                    <div>
                        <label className="text-white font-medium text-xs sm:text-sm block mb-2">Mot de passe</label>
                        <div className="relative">
                            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-cyan-600">
                                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 20 20">
